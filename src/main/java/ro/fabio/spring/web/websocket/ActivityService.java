package ro.fabio.spring.web.websocket;

import ro.fabio.spring.security.SecurityUtils;
import ro.fabio.spring.web.websocket.dto.ActivityDTO;
...
import static ro.fabio.spring.config.WebsocketConfiguration.IP_ADDRESS;
